...
```{r, eval=FALSE}
enteros <- c(25L,5L ,58L ,93L ,42L ,349L ,125L ,100L ,625L ,12L)
print(enteros)
```
...
```{r, eval=FALSE}
compClase <- c("francisco","nico","dayra","sahory","amayrani","itzel ","dafne ","melanny ","amairany")
print(compClase)
```
